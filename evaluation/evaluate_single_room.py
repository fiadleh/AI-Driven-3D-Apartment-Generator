...
Date: 2024-09-01
Version: 1.0
Description: Uses Blender API to evaluate one  3D room generated by instruct scene according to out-of-boundary metric.
"""
...
if __name__ == "__main__":
    ...
    body_type = 'ellipses' #'ellipses' , 'cylinders'
