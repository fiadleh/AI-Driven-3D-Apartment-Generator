...
class ThreedFutureModel(BaseThreedFutureModel):
    def __init__(
        ...
        print('------------------------- path_to_models 2:', self.path_to_models)
        exit()
    ...
    def path_to_openshape_vitg14_features(self):
        #print('------------------------- path_to_models 1 :', self.path_to_models)
        return os.path.join(
            self.path_to_models,
            self.model_jid,
    ...
    def openshape_vitg14_features(self):
        ...
        if os.path.exists(self.path_to_openshape_vitg14_features):
            ...
            #print('================  openshape_vitg14_features ', latent,'====================')
            return latent
        if os.path.exists("/home/user2024/Documents/repos/ai-driven-3d-apartment-generator/InstructScene/" + self.path_to_openshape_vitg14_features):
            edited_path= os.path.join("/home/user2024/Documents/repos/ai-driven-3d-apartment-generator/InstructScene/", self.path_to_openshape_vitg14_features)
            self.path_to_models = os.path.join("/home/user2024/Documents/repos/ai-driven-3d-apartment-generator/InstructScene/", self.path_to_models)
            latent = np.load(edited_path).astype(np.float32)
            #print('================ Edited !!!!! openshape_vitg14_features ', self.path_to_openshape_vitg14_features,'====================', flush=True)
            #print(latent)
            #if(random.randint(0, 1000) == 20):
            #exit()
            return latent
        else:
            print('================ NO!!!!! openshape_vitg14_features ', self.path_to_openshape_vitg14_features,'====================')
            return None
    ...
    def copy_from_other_model(self, other_model):
        print('\n##11111111111111111 \nself.path_to_models:', self.path_to_models,'\n###########################################\n')
