...
def get_textured_objects(
    ...
    for j in range(bbox_params_t.shape[0]):
        ...
        print("    --->  Loading :", furniture.raw_model_path)
...
def export_scene(
    ...
    if names is None:
        ...
        new_names = [f"object_{i}_{names[i]}.obj" for i in range(len(trimesh_meshes))]
        names = new_names
        #names = ['' if name is None else "object_"+name+"_"+str()+".obj" for name in names]
        print(names)
...
def _blender_binary_path() -> str:
    ...
    if os.path.exists("/home/user2024/Documents/repos/ai-driven-3d-apartment-generator/blender/blender"):
        return "/home/user2024/Documents/repos/ai-driven-3d-apartment-generator/blender/blender"
