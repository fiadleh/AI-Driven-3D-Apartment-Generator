...
def main(argv):
    ...
    parser.add_argument(
        ...
        default="/home/user2024/Documents/repos/ai-driven-3d-apartment-generator/InstructScene/dataset/3D-FRONT/3D-FUTURE-model",
        help="Path to the 3D-FUTURE dataset"
    )
    parser.add_argument(
        "--path_to_model_info",
        default="/home/user2024/Documents/repos/ai-driven-3d-apartment-generator/InstructScene/dataset/3D-FRONT/3D-FUTURE-model/model_info.json",
    ...
    print('\n888888888888888\n args.path_to_3d_future_dataset_directory:', args.path_to_3d_future_dataset_directory,'\n###########################################\n')
